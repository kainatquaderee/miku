<nav class='navbar flex-column bg-transparent border-0 d-flex'>
  <div class='container p-0'>
    ...
    <a href='https://github.com/kainatquaderee/miku/blob/main/spons.md' class='navbar-link navbar-link-with-icon pointer overflow-hidden donate mr-20 h-full' target='_blank'>
